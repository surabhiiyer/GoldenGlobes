...
\cf2 http://www.imdb.com/event/ev0000292\cf0  , which is the imdv page for Golden Globe Awards. The hosts, award winners and presenters are extracted from the tweets.\
\
...
\
The entry point to this system is from main.py\cf2  }